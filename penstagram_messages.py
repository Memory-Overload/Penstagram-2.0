messages = {
    ...
    "amity": {
        "bestBlight": [
            (0, "yo have you packed for the trip to the Knee tmrw?"),
            (0, "em and I already got our stuff together"),
            (0, "mom says you better do good on the presentation \"or else\""),
            (0, "also dad isn't coming"),
        ]
    }
}

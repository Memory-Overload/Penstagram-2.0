feeds = {
  ...
  "luz": [
    ...
    ["goodWitchLuzura", "10:16 AM", "lol but fr it's easy. just insert a link to the gif and it pops up."],
    ...
    ["veeeeeee", "10:20 AM", "it's from that frog show that Hunter likes. Amphibiland or whatever"],
    ["RULERZREACHF4N", "10:20 AM", "did someone mention Amphibiland"],
    ["RULERZREACHF4N", "10:20 AM", "My fav character (not includng Weed) is Colonel Wolterstorff, Bane of the Bullywugs, Destroyer of Danny Boy, and the Youngest Newt to Ever Achieve the Rank of Colonel in the Great Newtlandia Army"],

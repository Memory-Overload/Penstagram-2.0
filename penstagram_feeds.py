feeds = {
    "eda": [
        ["BADGIRLCOVEN", "10:09 AM",
            "Third mug of appleblood downed. Time to rob some schmucks blind."],
        ...
        ["goodWitchLuzura", "12:19 PM",
         "@em_ira @bestBlight which one of you stoll my scroll? - Amity"],
        ...
        ["veeeeeee", "12:25 PM", ":3"],
        ["MashPit", "12:25 PM",
         "Nearly got eaten a few minutes ago, but fought em off. RIP bozo, never stood a chance."],
    ...
    "darius": [
        ...
        ["rainey.day", "9:35 AM",
         "Just had a very relaxing tea with my breakfast. Time to start the day!"],
        ...
        ["Alabomdor_1", "2:49 PM",
            "I hope she-who-must-not-be-named rots for what she did."],
        ["chilly.lily", "2:50 PM", "Oh no. Don't tell me."],
        ["Alabomdor_1", "2:52 PM",
         "Don't be the fun police @chilly.lily :( drunk words, sober thoughts, ya know?"],
        ...
        ["chilly.lily", "2:53 PM",
         "Titan have mercy. This is a public forum and you two are clearly intoxicated."],
        ...
        ["Alabomdor_1", "3:00 PM",
         "@chilly.lily Please. Please. Please. <i>Pleeeeaseeee?</i> I'll stop if you buy something."],
        ["chilly.lily", "3:01 PM",
            "@Alabomdor_1 Fine. I'll come over. Give me a few minutes."],
        ["goo-daddy", "4:20 PM",
         "Mistakes are being made. Fun mistakes, but mistakes nonetheless."],
        ["chilly.lily", "4:34 PM",
            "I now see why @BADGIRLCOVEN likes apple blood so much."],
    ...
    "raine": [
        ["rainey.day", "2:07 AM",
         "Just did a line of rosin powder. Let's get this money, bards."],
        ["skara4real", "8:24 AM",
            "Hot Take: Violas are better than violins in every aspect."],
        ["_derwin", "8:27 AM", "@skara4real lmao wrong. Bassoons are obviously the best. Violin and viola are just battling for 2nd."],
        ["FreeTheLemons", "8:30 AM",
         "@_derwin @skara4real You are both wrong. Theremin is indubitably the coolest."],
        ["_derwin", "8:30 AM",
         "@FreeTheLemons Wow, I can't believe you actually know the word 'indubitably.'"],
        ["FreeTheLemons", "8:32 AM",
         "@_derwin Verily, my vast vocabulary vastly vindicates my verbal virtuosity, verifying my verbose volubility."],
        ...
        ["skara4real", "8:36 AM",
         "all this because I said that violas are better. (still true, btw.)"],
        ["bo-lieve", "9:41 AM",
         "Yo, @goops, can I get an expedited review for my DR-HR Exchange Program appliaction?"],
        ...
        ["FreeTheLemons", "10:07 AM",
         "@rainey.day How many snails for you to the Monarch In Orange?"],
        ...
        ["amberamberamber", "12:19 AM",
         "if @BADGIRLCOVEN is our mom, does that make @KINGOFDEMONS our brother???"],
        ["BADGIRLCOVEN", "12:22 AM", "That's not how that works, kid. Like, at all."],
        ["BADGIRLCOVEN", "12:22 AM",
         "Also, I'm not even your mom, technically. Raine and I haven't tied the knot yet, and probably never will."],
        ["amberamberamber", "12:24 AM",
            "dang, I thought that would be cool to brag about."],
        ["BADGIRLCOVEN", "12:25 AM",
         "Yeah, well that's the way the spookie crumbles sometimes."],
        ["BADGIRLCOVEN", "2:17 AM",
            "WHERE THE <i><b>HOOT</b></i> DID MY APPLE BLOOD GO?!"],
        ["steve", "3:00 AM", "steve."],
    ],
    "luz": [
        ...
        ["goodWitchLuzura", "10:13 AM",
         "<img src='https://raw.githubusercontent.com/Memory-Overload/Penstagram-2.0/main/images/secrets.gif' class='pm_image'>"],
        ["veeeeeee", "10:14 AM", "how'd you do that."],
        ["goodWitchLuzura", "10:14 AM", "do what? :-P"],
        ["veeeeeee", "10:15 AM", "the gif."],
        ["goodWitchLuzura", "10:15 AM", "little sister magic"],
        ["veeeeeee", "10:16 AM", "touche."],
        ["goodWitchLuzura", "10:16 AM",
         "lol but fr it's easy. just insert a link to the gif and it pops up."],
        ["veeeeeee", "10:17 AM", "wait really?"],
        ["veeeeeee", "10:17 AM", "it's that easy?"],
        ["veeeeeee", "10:17 AM", "hol up let me try"],
        ["veeeeeee", "10:19 AM", "<img src='https://raw.githubusercontent.com/Memory-Overload/Penstagram-2.0/main/images/hop%20pop%20breaking%20it%20down%20crazy%20style.gif' class='pm_image'>"],
        ["goodWitchLuzura", "10:20 AM", "lmao what is that gif."],
        ["veeeeeee", "10:20 AM",
         "it's from that frog show that Hunter likes. Amphibiland or whatever"],
        ["RULERZREACHF4N", "10:20 AM", "did someone mention Amphibiland"],
        ["RULERZREACHF4N", "10:20 AM",
         "My fav character (not includng Weed) is Colonel Wolterstorff, Bane of the Bullywugs, Destroyer of Danny Boy, and the Youngest Newt to Ever Achieve the Rank of Colonel in the Great Newtlandia Army"],
        ["goodWitchLuzura", "10:21 AM", "bro had that copypasta at the ready lmao."],
        ["RULERZREACHF4N", "10:21 AM", "whats copypasta"],
        ["goodWitchLuzura", "10:22 AM", "its a funny thing you copy and share online."],
        ["goodWitchLuzura", "10:23 AM", "What the frick did you just fricking say about me, you little meanie? I'll have you know I graduated top of my class in the Navy Seals, and I've been involved in numerous secret raids on Al-Quaeda, and I have over 300 confirmed kills. I am trained in gorilla warfare and I'm the top sniper in the entire US armed forces. You are nothing to me but just another target. I will wipe you the frick out with precision the likes of which has never been seen before on this Earth, mark my fricking words. You think you can get away with saying that stuff to me over the Internet? Think again, buddy. As we speak I am contacting my secret network of spies across the USA and your IP is being traced right now so you better prepare for the storm, maggot. The storm that wipes out the pathetic little thing you call your life. You're freaking dead, kid. I can be anywhere, anytime, and I can kill you in over seven hundred ways, and that's just with my bare hands. Not only am I extensively trained in unarmed combat, but I have access to the entire arsenal of the United States Marine Corps and I will use it to its full extent to wipe your miserable butt off the face of the continent, you little meanie pants. If only you could have known what unholy retribution your little \"clever\" comment was about to bring down upon you, maybe you would have held your freaking tongue. But you couldn't, you didn't, and now you're paying the price, you gosh darn idiot. I will poo fury all over you and you will drown in it. You're screwed, kiddo."],
        ["veeeeeee", "10:25 AM", "do you just have that saved or something?"],
        ["goodWitchLuzura", "10:26 AM", "yes, yes I do."],
    ],
    "amity": [
        ["WitchChick128", "12:32 PM",
            "I regret to say that I have made ammends with the bird tube."],
        ["HOOOOOOOOOT", "12:33 PM",
            "THANK YOU NEW BESTIE HOOT HOOT"],
    ],
}

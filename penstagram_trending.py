...
for_you = {
  "eda": [
    ...
    ["Hello_willow", "7:58 AM", "Ooh, I might steal that idea. Kikimora's face would fit well on my speedbag."],
    ["veeeeeee", "9:21 AM", "I never want to hear about Barbara's rhubarbs ever again."],
    ["MashPit", "9:22 AM", "Was hast du gegen Rhabarberbarbarabarbarbarenbartbarbierbier?"],
...
trending = {
  ...
  "darius": [
    ["UWM", "4:00 PM", "New Course Alert: Introduction to Human Technologies (HUMA 160). Taught by @goops, this course will focus on how technology from the Human Realm compares to our own."],
  ],
  "raine": [
